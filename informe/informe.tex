...
Se esperaba que la funcion maximum_concurrent ejecute mas rápido que la función maximum. Sin embargo luego de ver los resultados de la experimentación y analizar el código se llegó a la conclusión de que la función maximum es más rápida ya que hace un mejor uso de los threads. Se observó que a mayor cantidad de threads los tiempos de ejecución diminuían para ambas funciones.
